...
->  Qualified Aircraft Maintenance Engineer (AME) and Aeronautical Engineer

->  Recently passed out from college with strong theoretical and practical foundations in aviation engineering

->  Academic and project-based experience on Airbus A320 family, including A320 flight simulator

->  Trained on Learjet 23 and Cessna 150, covering aircraft systems, performance, and basic maintenance concepts

  Strong understanding of aircraft structures, powerplant, avionics fundamentals, and maintenance documentation

  Passionate about aviation safety, system-level understanding, and continuous learning
...
Airbus A320 Aircraft Systems (academic & project-based)

   -> A320 Flight Simulator Operations (procedural & systems understanding)

   -> Learjet 23M Systems & Performance (training exposure)

   -> Cessna 150 Airframe & Engine Fundamentals
...
🔧 Maintenance & Engineering
   ...
   AMM, IPC, and basic technical documentation interpretation

   Aircraft structures & materials

   Powerplant fundamentals

   Basic avionics concepts
...
🧭 Airbus A320 Simulator-Based Study
  ...
  -> Hands-on exposure to A320 simulator environment

 Understanding of:

   -> Normal and abnormal procedures

   -> Cockpit layout and system indications

   -> Crew coordination basics

   -> Emphasis on procedural discipline and system awareness


🛩️ Learjet 23M – Training Exposure

  -> Studied aircraft performance characteristics and limitations

  -> Overview of powerplant and flight control systems

 -> Understanding of business jet operational concepts
...
❤️ Interests & Professional Focus
   ...
   Commercial aircraft systems (Airbus family)

   Aircraft maintenance procedures and safety

   Flight simulation for system understanding

   Aviation technology and continuous skill development
